...
extern osThreadId_t FDCANTxTaskHandle;
extern osThreadId_t FDCAN2RxTaskHandle;
extern osThreadId_t FDCAN1RxTaskHandle;
extern osThreadId_t NtpManagerTaskHandle;
extern osThreadId_t CANCarTxTaskHandle;
extern osThreadId_t CANCarRxTaskHandle;
extern osThreadId_t CANCarHBTaskHandle;
extern osThreadId_t CANManagerTaskHandle;
extern osThreadId_t JsonGenerateTaskHandle;
extern osThreadId_t JsonParseTaskHandle;
extern osThreadId_t MqttErrorHandleTaskHandle;
extern osThreadId_t MqttHeartBeatTaskHandle;
extern osThreadId_t RegisterManagerTaskHandle;
extern osThreadId_t RegisterHandleTaskHandle;
extern osThreadId_t Status_TaskHandle;
extern osMutexId_t wifiUsartMutexHandle;
extern osMutexId_t mqttMutexHandle;
extern osMutexId_t actionMutexHandle;
extern osMutexId_t stateMutexHandle;
extern osMutexId_t configMutexHandle;
extern osMutexId_t featureMutexHandle;
extern osMutexId_t notifyMutexHandle;
...
extern osMessageQueueId_t JsonGenerateQueueHandle;
extern osMessageQueueId_t JsonParseQueueHandle;
extern osMessageQueueId_t MqttErrorHandleQueueHandle;
...
extern void vMqttNotifyTask(void *argument);
extern void vFDCANTxTask(void *argument);
extern void vFDCAN2RxTask(void *argument);
extern void vFDCAN1RxTask(void *argument);
extern void vNtpManagerTask(void *argument);
extern void vCANCarTxTask(void *argument);
extern void vCANCarRxTask(void *argument);
extern void vCANCarHBTask(void *argument);
extern void vCANManagerTask(void *argument);
extern void vJsonGenerateTask(void *argument);
extern void vJsonParseTask(void *argument);
extern void vMqttErrorHandleTask(void *argument);
extern void vMqttHeartBeatTask(void *argument);
extern void vRegisterManagerTask(void *argument);
extern void vRegisterHandleTask(void *argument);
extern void vStatus_Task(void *argument);
