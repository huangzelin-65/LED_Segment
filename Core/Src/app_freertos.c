...
void MX_FREERTOS_Init(void) {
  ...
  xInterrupt_QueueHandle = osMessageQueueNew (16, sizeof(uint8_t), &xInterrupt_Queue_attributes);
  /* creation of xMotion_Queue */
  xMotion_QueueHandle = osMessageQueueNew (16, sizeof(uint8_t), &xMotion_Queue_attributes);
  /* creation of xSensor_Queue */
  xSensor_QueueHandle = osMessageQueueNew (16, sizeof(uint8_t), &xSensor_Queue_attributes);
