...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PB13     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = Rfid_Car_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(Rfid_Car_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = Rfid_Car_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF14_UART5;
    HAL_GPIO_Init(Rfid_Car_TX_GPIO_Port, &GPIO_InitStruct);
    ...
    /* GPDMA2_REQUEST_UART5_TX Init */
    NodeConfig.NodeType = DMA_GPDMA_LINEAR_NODE;
    NodeConfig.Init.Request = GPDMA2_REQUEST_UART5_TX;
    NodeConfig.Init.BlkHWRequest = DMA_BREQ_SINGLE_BURST;
    NodeConfig.Init.Direction = DMA_PERIPH_TO_MEMORY;
    ...
    NodeConfig.DataHandlingConfig.DataExchange = DMA_EXCHANGE_NONE;
    NodeConfig.DataHandlingConfig.DataAlignment = DMA_DATA_RIGHTALIGN_ZEROPADDED;
    if (HAL_DMAEx_List_BuildNode(&NodeConfig, &Node_GPDMA2_Channel3) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_InsertNode(&List_GPDMA2_Channel3, NULL, &Node_GPDMA2_Channel3) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_SetCircularMode(&List_GPDMA2_Channel3) != HAL_OK)
    {
      Error_Handler();
    }

    handle_GPDMA2_Channel3.Instance = GPDMA2_Channel3;
    handle_GPDMA2_Channel3.InitLinkedList.Priority = DMA_LOW_PRIORITY_LOW_WEIGHT;
    handle_GPDMA2_Channel3.InitLinkedList.LinkStepMode = DMA_LSM_FULL_EXECUTION;
    handle_GPDMA2_Channel3.InitLinkedList.LinkAllocatedPort = DMA_LINK_ALLOCATED_PORT0;
    handle_GPDMA2_Channel3.InitLinkedList.TransferEventMode = DMA_TCEM_BLOCK_TRANSFER;
    handle_GPDMA2_Channel3.InitLinkedList.LinkedListMode = DMA_LINKEDLIST_CIRCULAR;
    if (HAL_DMAEx_List_Init(&handle_GPDMA2_Channel3) != HAL_OK)
    {
      Error_Handler();
    }

    if (HAL_DMAEx_List_LinkQ(&handle_GPDMA2_Channel3, &List_GPDMA2_Channel3) != HAL_OK)
    {
      Error_Handler();
    }

    __HAL_LINKDMA(huart, hdmatx, handle_GPDMA2_Channel3);
  ...
  */
    ...
    PE0     ------> UART8_RX
    */
    GPIO_InitStruct.Pin = Rfid_Box_TX_Pin|Rfid_Box_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    handle_GPDMA2_Channel0.Init.Request = GPDMA2_REQUEST_UART8_RX;
  ...
  */
    ...
    */
    ...
    handle_GPDMA1_Channel3.Init.Request = GPDMA1_REQUEST_USART6_TX;
  ...
  */
    ...
    PF4     ------> USART11_RX
    */
    GPIO_InitStruct.Pin = NUMDISP_TX_Pin|NUMDISP_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* USART11 interrupt Init */
    HAL_NVIC_SetPriority(USART11_IRQn, 5, 0);
    HAL_NVIC_EnableIRQ(USART11_IRQn);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==UART5)
  {
    ...
    PB13     ------> UART5_TX
    */
    HAL_GPIO_DeInit(GPIOB, Rfid_Car_RX_Pin|Rfid_Car_TX_Pin);
  ...
  else if(huart->Instance==UART7)
  {
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOE, Motor_TX_Pin|Motor_RX_Pin);
  ...
  else if(huart->Instance==UART8)
  {
    ...
    PE0     ------> UART8_RX
    */
    HAL_GPIO_DeInit(GPIOE, Rfid_Box_TX_Pin|Rfid_Box_RX_Pin);
  ...
  else if(huart->Instance==USART11)
  {
    ...
    PF4     ------> USART11_RX
    */
    HAL_GPIO_DeInit(GPIOF, NUMDISP_TX_Pin|NUMDISP_RX_Pin);

    /* USART11 interrupt DeInit */
    HAL_NVIC_DisableIRQ(USART11_IRQn);
