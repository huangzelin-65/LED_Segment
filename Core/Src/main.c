...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, BOX_5V_Pin|Rfid_Car_Power_Pin|Wifi_Power_Pin|LED5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ELOCK_EN1_GPIO_Port, ELOCK_EN1_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(NUMDISP_485_CTRL_GPIO_Port, NUMDISP_485_CTRL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LOW_VOLTAGE_DET_Pin */
  GPIO_InitStruct.Pin = LOW_VOLTAGE_DET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(LOW_VOLTAGE_DET_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Encoder_S2_4_Pin Encoder_S2_8_Pin Encoder_S3_8_Pin Encoder_S3_1_Pin */
  GPIO_InitStruct.Pin = Encoder_S2_4_Pin|Encoder_S2_8_Pin|Encoder_S3_8_Pin|Encoder_S3_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : Encoder_S3_4_Pin */
  GPIO_InitStruct.Pin = Encoder_S3_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Encoder_S3_4_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : BOX_5V_Pin */
  GPIO_InitStruct.Pin = BOX_5V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BOX_5V_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : ELOCK_EN1_Pin Rfid_Car_Power_Pin Wifi_Power_Pin LED5_Pin */
  GPIO_InitStruct.Pin = ELOCK_EN1_Pin|Rfid_Car_Power_Pin|Wifi_Power_Pin|LED5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : NUMDISP_485_CTRL_Pin */
  GPIO_InitStruct.Pin = NUMDISP_485_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NUMDISP_485_CTRL_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : UV_CLEAN_EN_Pin ELOCK_EN2_Pin */
  GPIO_InitStruct.Pin = UV_CLEAN_EN_Pin|ELOCK_EN2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOI, &GPIO_InitStruct);

  /*Configure GPIO pin : Encoder_S3_2_Pin */
  GPIO_InitStruct.Pin = Encoder_S3_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Encoder_S3_2_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : FC_H_Pin Encoder_S2_2_Pin Encoder_S2_1_Pin FP_L_Pin */
  GPIO_InitStruct.Pin = FC_H_Pin|Encoder_S2_2_Pin|Encoder_S2_1_Pin|FP_L_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pins : RC_H_Pin RC_L_Pin */
  GPIO_InitStruct.Pin = RC_H_Pin|RC_L_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pins : LED1_Pin LED2_Pin LED4_Pin LED3_Pin */
  ...
  /*Configure GPIO pin : MOTOR_485_CTRL_Pin */
  GPIO_InitStruct.Pin = MOTOR_485_CTRL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(MOTOR_485_CTRL_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : Encoder_S1_1_Pin */
  GPIO_InitStruct.Pin = Encoder_S1_1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  ...
  /*Configure GPIO pin : Encoder_S1_2_Pin */
  GPIO_InitStruct.Pin = Encoder_S1_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Encoder_S1_2_GPIO_Port, &GPIO_InitStruct);
