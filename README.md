# TransGuard2.0-Embedded

TransGuard2.0嵌入式软件系统
...
```
cd existing_repo
git remote add origin https://git.midea.com/DEP-RIAD/swisslog-healthcare/transguard2.0-embedded.git
git branch -M main
...
- [ ] [Set up project integrations](http://git.midea.com/DEP-RIAD/swisslog-healthcare/transguard2.0-embedded/-/settings/integrations)
